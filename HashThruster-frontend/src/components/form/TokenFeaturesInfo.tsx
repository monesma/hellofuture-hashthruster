  ...
  return (
    <form>
      <label htmlFor="mainPurpose">
        Main purpose of the token (max 500 characters) (required)
      </label>
      <textarea
        id="mainPurpose"
        value={tokenPurpose}
      ...
      <label htmlFor="supply">Token supply (required)</label>
      <input
        id="supply"
        type="text"
        value={tokenSupply}
      ...
      <label htmlFor="policy">
        Token distribution policy (max 500 characters) (required)
      </label>
      <textarea
        id="policy"
      ...
      <label htmlFor="comply">
        Does the token comply with a specific Hedera standard? (required)
      </label>
      <input
        id="comply"
        type="text"
        ...
        placeholder="e.g., HTS"
      />
      <label htmlFor="hashscanLink">HashScan Link</label>
      <input
        id="hashscanLink"
        type="text"
        value={hashscanLink}
        onChange={handleHashscanLinkChange}
        placeholder="e.g., https://hashscan.io/..."
      />
      <div className="valid">
